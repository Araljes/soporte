...
class Email extends PHPMailer{
    ...
    protected $gCorreo = 'incidenciascctv@duna.com.mx';
    protected $gContrasena = 'S1st3m4s-dun4';
    ...
    public function ticket_abierto($tick_id){
        ...
        //IGual//
        $this->IsSMTP();
        $this->Host = 'securemail25.carrierzone.com';//Aqui el server
        ...
        $this->addCC('jldejesus@duna.com.mx','Jose Luis De Jesus');
        $this->addCC('icruz@duna.com.mx','Israel Cruz');
        $this->addCC('vrosales@duna.com.mx','Victor Rosales');
        $this->addCC('jaragon@duna.com.mx','Jesus Aragon');
        $this->WordWrap = 50;
        $this->IsHTML(true);
        ...
        $cuerpo = str_replace("lblEmp", $empresa, $cuerpo);
