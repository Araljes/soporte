<?php
    class Ticket extends Conectar{
        ...
        public function insert_ticket($usu_id,$cat_id,$tick_titulo,$emp_id,$tick_descrip){
            $conectar= parent::conexion();
            parent::set_names();
            $sql="INSERT INTO tm_ticket (tick_id,usu_id,cat_id,tick_titulo,tick_empresa,tick_descrip,tick_estado,fech_crea,usu_asig,fech_asig,est) VALUES (NULL,?,?,?,?,?,'Abierto',now(),NULL,NULL,'1');";
        ...
        public function listar_ticket_x_id($tick_id){
            ...
            $sql="SELECT 
                ...
                tm_ticket
                INNER join tm_categoria on tm_ticket.cat_id = tm_categoria.cat_id
                INNER join empresa on tm_ticket.tick_empresa = empresa.emp_id
                INNER join tm_usuario on tm_ticket.usu_id = tm_usuario.usu_id
                WHERE
                tm_ticket.est = 1
